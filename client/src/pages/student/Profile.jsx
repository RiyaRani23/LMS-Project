...
const Profile = () => {
  const enrolledCourses = [1, 2]; // Mock data
  ...
  return (
    <div className="max-w-4xl mx-auto my-24 px-4 md:px-0">
        ...
        <div className="flex-1 space-y-4">
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-gray-900 dark:text-white">aarav.kumar@example.com</p>
            </div>
            <div className="flex items-center gap-2">
      ...
      <div className="mt-12">
        <h2 className="font-semibold text-lg mb-4">Courses you're enrolled in</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
           {enrolledCourses.length > 0 ? (
             [1, 2].map((course) => (
                <div key={course} className="h-32 bg-slate-100 dark:bg-slate-800 rounded-lg animate-pulse" />
             ))
           ) : (
